...
{
    public partial class FrmRF1 : Form
    {
        public FrmRF1()
        {
            InitializeComponent();
            this.Load += FrmRF1_Load;
        }

        private void FrmRF1_Load(object sender, EventArgs e)
        {
            if (GateWayService.LanguageStr == "zh-CN" || GateWayService.LanguageStr == "en-US")
            {
                ...
                MultiLanguage.LoadLanguage(this, typeof(FrmRF1));
            }
            this.btn_Enab.Active = GateWayService.reader1.Conn;
            this.GetConfigData();
        ...
        private void Timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            try
            {
                Invoke(new Action(() =>
                {
                    ...
                    {
                        this.led_TagPre.State = GateWayService.reader1.TagPresent ? UILightState.On : UILightState.Off;
                        this.led_Conn.State = GateWayService.reader1.Conn ? UILightState.On : UILightState.Off;
                        this.txt_RSSI.Text = GateWayService.reader1.RSSI.ToString();
                        this.txt_UidLen.Text = GateWayService.reader1.DataLen.ToString();
                        this.txt_UID.Text = DataTran.GetHexArray(GateWayService.reader1.UidData.ByteArray);
                    }
                }));
        ...
        private void btn_Enab_ValueChanged(object sender, bool value)
        {
            ...
            {
                GateWayService.EN.EnableReader(Reader.RF1, false);
            }
        }
        ...
        private async void btn_Read_Click(object sender, EventArgs e)
        {
            ...
            Task<ReadResult> t = new Task<ReadResult>(new Func<ReadResult>(() =>
            {
                ReadResult data = GateWayService.EN.ReadTagUsers(Reader.RF1, Addr, Count);
                return data;
            }));
        ...
        private async void btn_Write_Click(object sender, EventArgs e)
        {
            ...
            {
                WriteResult wres = GateWayService.EN.WriteTagUsers(Reader.RF1, Addr, Count, data.ByteArray);
                return wres;
            }));
        ...
        private void FrmRF1_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.timer.Stop();
            this.SaveConfigData();
        }
