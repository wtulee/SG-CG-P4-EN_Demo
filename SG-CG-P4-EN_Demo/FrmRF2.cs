...
{
    public partial class FrmRF2 : Form
    {
        public FrmRF2()
        {
            InitializeComponent();
            this.Load += FrmRF2_Load;
        }

        private void FrmRF2_Load(object sender, EventArgs e)
        {
            if (GateWayService.LanguageStr == "zh-CN" || GateWayService.LanguageStr == "en-US")
            {
                ...
                MultiLanguage.LoadLanguage(this, typeof(FrmRF2));
            }
            this.btn_Enab.Active = GateWayService.reader2.Conn;
            this.GetConfigData();
        ...
        private void Timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            try
            {
                Invoke(new Action(() =>
                {
                    ...
                    {
                        this.led_TagPre.State = GateWayService.reader2.TagPresent ? UILightState.On : UILightState.Off;
                        this.led_Conn.State = GateWayService.reader2.Conn ? UILightState.On : UILightState.Off;
                        this.txt_RSSI.Text = GateWayService.reader2.RSSI.ToString();
                        this.txt_UidLen.Text = GateWayService.reader2.DataLen.ToString();
                        this.txt_UID.Text = DataTran.GetHexArray(GateWayService.reader2.UidData.ByteArray);
                    }
                }));
        ...
        private void btn_Enab_ValueChanged(object sender, bool value)
        {
            ...
            {
                GateWayService.EN.EnableReader(Reader.RF2, false);
            }
        }
        ...
        private async void btn_Read_Click(object sender, EventArgs e)
        {
            ...
            {
                ReadResult data = GateWayService.EN.ReadTagUsers(Reader.RF2, Addr, Count);
                return data;
            }));
        ...
        private async void btn_Write_Click(object sender, EventArgs e)
        {
            ...
            {
                WriteResult wres = GateWayService.EN.WriteTagUsers(Reader.RF2, Addr, Count, data.ByteArray);
                return wres;
            }));
        ...
        private void FrmRF2_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.timer.Stop();
            this.SaveConfigData();
        }
