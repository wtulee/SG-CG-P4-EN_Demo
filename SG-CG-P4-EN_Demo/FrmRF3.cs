...
{
    public partial class FrmRF3 : Form
    {
        public FrmRF3()
        {
            InitializeComponent();
            this.Load += FrmRF3_Load;
        }

        private void FrmRF3_Load(object sender, EventArgs e)
        {
            this.btn_Enab.Active = GateWayService.reader3.Conn;
            this.GetConfigData();
        ...
        private void Timer_Elapsed(object sender, ElapsedEventArgs e)
        {
            try
            {
                Invoke(new Action(() =>
                {
                    ...
                    {
                        this.led_TagPre.State = GateWayService.reader3.TagPresent ? UILightState.On : UILightState.Off;
                        this.led_Conn.State = GateWayService.reader3.Conn ? UILightState.On : UILightState.Off;
                        this.txt_RSSI.Text = GateWayService.reader3.RSSI.ToString();
                        this.txt_UidLen.Text = GateWayService.reader3.DataLen.ToString();
                        this.txt_UID.Text = DataTran.GetHexArray(GateWayService.reader3.UidData.ByteArray);
                    }
                }));
            }
            catch (Exception)
        ...
        private void btn_Enab_ValueChanged(object sender, bool value)
        {
            ...
            {
                GateWayService.EN.EnableReader(Reader.RF3, false);
            }
        }
        ...
        private async void btn_Read_Click(object sender, EventArgs e)
        {
            ...
            {
                ReadResult data = GateWayService.EN.ReadTagUsers(Reader.RF3, Addr, Count);
                return data;
            }));
        ...
        private async void btn_Write_Click(object sender, EventArgs e)
        {
            ...
            {
                WriteResult wres = GateWayService.EN.WriteTagUsers(Reader.RF3, Addr, Count, data.ByteArray);
                return wres;
            }));
        ...
        private void FrmRF3_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.timer.Stop();
            this.SaveConfigData();
        }
